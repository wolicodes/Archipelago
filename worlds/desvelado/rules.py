...
def set_all_entrance_rules(world: DesveladoWorld) -> None:
    ...
    stage2_2_laser_eyes = world.get_entrance("2-2 room 3-13 -> 2-2 room 14-end")

    stage2_3_double_keys = world.get_entrance("2-3 room 1-2 -> 2-3 room 3")
    stage2_3_laser_eyes = world.get_entrance("2-3 room 3 -> 2-3 room 4")
    ...
    stage3_2_dash_walls = world.get_entrance("3-2 room 1-2 -> 3-2 room 3-5")
    ...
    world.set_rule(stage3_3_eyes_walls, HAS_LASER_EYES & HAS_DASH_WALLS)
